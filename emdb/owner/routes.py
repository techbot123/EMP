    ...
    if form.validate_on_submit():
        if form.edit.data:
            ...
            return redirect(url_for('.employee_set_pay', email_id = email_id,\
                                                                    pay = pay))
    return render_template('review_pay.html', form = form, pay = pay, \
    ...
    if form.validate_on_submit():
        if form.edit.data:
            ...
            return redirect(url_for('.employee_set_inc', email_id = email_id,\
                                                                    inc = inc))
    return render_template('review_pay.html', form = form, pay = inc, \
    ...
    if form.validate_on_submit():
        if form.edit.data:
            ...
            return redirect(url_for('.employee_set_dec', email_id = email_id,\
                                                                    dec = dec))
    return render_template('review_pay.html', form = form, pay = dec, \
